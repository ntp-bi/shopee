...
/**
 * Servlet implementation class xacnhanNowController
 */
@WebServlet("/xacnhanNowController")
public class xacnhanNowController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public xacnhanNowController() {
		super();
