                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form action="AdminRegisterController" method="post">
	                        ...
	                        <div class="form-floating mb-3">
	                            <input type="text" name="name" class="form-control" id="floatingInput" placeholder="Họ và tên">
                        ...
                        <p class="text-center mb-0">Bạn đã có tài khoản? <a href="./AdminLoginController">Đăng nhập</a></p>
                    </div>
                </div>
            </div>
        </div>
