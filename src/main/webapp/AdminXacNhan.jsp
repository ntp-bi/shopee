        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="AdminLoaiController" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Danh mục</a>                    
			                ...
			                %>
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                    	<a class="btn btn-sm btn-primary" href="AdminXacNhanController?mct=<%=xn.getMaChiTietHD()%>">
                                    		Xóa
                                    	</a>
                                    </td>
                                    <td style="text-align: center;">
                                    	<a class="btn btn-sm btn-success" href="AdminXacNhanController?mct=<%=xn.getMaChiTietHD()%>">
                                    		Xác Nhận
                                    	</a>
                                    </td>
                                </tr>
