                    ...
                    <div class="checkout__wrapper">
                        ...
                        <div class="product_checkout">
                            ...
                            <div class="container-shipping-mess">
                                ...
                                <div class="shipping-mess-footer">
                                    ...
                                    <span class="mess-footer-price">₫<%=gh.TongTien() %></span>
                                </div>
                            </div>
                            ...
                            <div class="container-checkout-mobile">
                                <span>Thành tiền:</span>
                                <span class="sum-mobile">₫<%=gh.TongTien() %></span>
                            </div>
                        </div>
                        <div class="payment_checkout">
                            ...
                            <div class="payment-fee">
                                <div class="payment-fee-sum">
                                    ...
                                    <span class="fee-sum-price">₫<%=gh.TongTien() %></span>
                                </div>
                                ...
                                <div class="payment-fee-payment">
                                    ...
                                    <span class="fee-payment">₫<%=gh.TongTien() %></span>
                                </div>
                            </div>
                            ...
                            <form class="payment-btn" action="xacnhanController" method="post"> 
                        ...
                        <div class="sum-pay-mobile">
                            <div class="sum-pay-mobile-left">
                                ...
                                <span class="active">₫<%=gh.TongTien() %></span>
                            </div>
