                            ...
                            <div class="header__cart-list">                                									
                                ...
                                %>
                                    ...
                                    <li class="header__cart-item">
                                        <img src="https://cf.shopee.vn/file/sg-11134201-22090-4nfx601usthvc6_tn" alt=""
                                        ...
                                        <div class="header__cart-item-info">
                                            <div class="header__cart-item-head">
                                                ...
                                                <div class="header__cart-item-price-wrap">
                                                    <span class="header__cart-item-price"><%=g.getGia()%>.000đ</span>
                        ...
                        <div class="history-list-product-box">
                            <div class="history-list-product">
                                ...
                                <div class="list-product-item">
                                    ...
                                    <div class="product-item-content">
                                        <span class="name"><%=lsmua.getTensach() %></span>
                                        <span class="classify">Phân loại: sách</span>
                                        <span class="quantity">x<%=lsmua.getSoluongmua() %></span>
                                    </div>
                                    <div class="product-item-price">
                                        <span class="product-item-price-old">₫439.000</span>
                                        <span class="product-item-price-cur">₫<%=lsmua.getGia() %></span>
                                    </div>
                                </div>
                            </div>
                            <div class="history-list-product-checkout">
                                <div class="checkout">
                                    ...
                                    <span class="price">₫<%=lsmua.getThanhtien() %></span>
                                </div>
                                <div class="button">
