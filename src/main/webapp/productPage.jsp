        ...
        <header class="header header-mobile">
            <div class="grid wide"> <!-- kích thước width = 1200px nên nó tự động căn = kích thước 1200px  -->
                ...
                <div class="header-with-search">
                    ...
                    <form action="./productPageController" method="post"  class="header__search header__search-page">
                ...
                <div class="row sm-gutter main__content">
                        ...
                        <nav class="category">
                            ...
                            for(loaibean l:dsloai){%>
                                <li class="category-item">
                                    <a href="productPageController?ml=<%= l.getMaloai() %>" class="category-item__link">
                                    	<%=l.getTenloai() %>
                                    </a>
                                </li>
                                <%} %>
                    ...
                    <div class="col l-10 m-12 c-12">
                        ...
                        <div class="home-product">
							...
							%>		
                                <div class="col l-2-4 m-4 c-6">
                                    <a class="home-product-item" href="./productDetailController?ms=<%=s.getMasach()%>&ts=<%= s.getTensach()%>&gia=<%=s.getGia()%>&anh=<%=s.getAnh()%>">
                                        <div class="home-product-item__img"
                                            style="background-image: url(<%=s.getAnh()%>)">                                          
                                        </div>
                                        <h4 class="home-product-item__name"><%=s.getTensach() %></h4>
                        ...
                        <ul class="pagination home-product__pagination">
                            ...
                            <%for(int i = 1; i <= 10; i++) { %>
                            <li class="pagination-item">
                                <a href="productPageController?t=<%=i %>" class="pagination-item__link"><%=i %></a>
                            </li>                            
                            <%} %>
                            <li class="pagination-item">
                                <a href="" class="pagination-item__link">
